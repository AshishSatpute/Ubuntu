...
public class CardWizard extends AppCompatActivity {
    ...
    private void bottomProgressDots(int current_index) {
        ...
        if (dots.length > 0) {
            ...
            dots[current_index].setColorFilter(getResources().getColor(R.color.blue_grey_300), PorterDuff.Mode.SRC_IN);
        }
    }
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (current < MAX_STEP) {
                        ...
                        Intent in = new Intent(CardWizard.this,LoginActivity .class);
                        startActivity(in);
                    }
                }
            });
